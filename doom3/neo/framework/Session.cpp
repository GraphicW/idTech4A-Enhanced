...
idCVar  idSessionLocal::com_unlockRenderFPS("com_unlockRenderFPS", "0", CVAR_SYSTEM | CVAR_ARCHIVE | CVAR_BOOL, "allow rendering faster than the 60hz simulation tick");
...
void idSessionLocal::ExecuteMapChange(bool noFadeWipe)
{
	...
	if (!reloadingSameMap) {
		...
		// Force all map-referenced image work to complete while loading.
		UpdateScreen(true);
...
void idSessionLocal::Frame()
{
	...
	if (com_unlockRenderFPS.GetBool())
	{
