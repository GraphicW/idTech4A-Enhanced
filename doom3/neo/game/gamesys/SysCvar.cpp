...
idCVar g_precacheParticleDecls("g_precacheParticleDecls", "1", CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "Force all particle declarations to parse during map load");
idCVar g_precacheFXDecls("g_precacheFXDecls", "1", CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "Force all FX declarations to parse during map load");
idCVar g_precacheEffectDecls("g_precacheEffectDecls", "1", CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "Force all effect declarations to parse during map load");
