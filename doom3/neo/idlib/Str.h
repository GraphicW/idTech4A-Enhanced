...
// Ensure standard integer types and assert are available for all translation units
#include "IDLIB_PCH.h"
#include <cstdint>
#include <cassert>

// --- add this near the top of doom3/neo/idlib/Str.h, before any ID_INLINE usage ---
#ifndef ID_INLINE
#if defined(_MSC_VER)
...
// Ensure core idlib math types and list template are visible to headers that follow
#include <cmath>
#include "math/Math.h"
