...
#ifdef _POSTPROCESS
		idImage* frameImage;
		idImage* hdrSceneImage;
		idImage* gtaoHistoryImage;
		idImage* mirrorImage;
		idImage* hdrBloomImageA;
		idImage* hdrBloomImageB;
		idImage* hdrLuminanceImageA;
		idImage* hdrLuminanceImageB;
		idImage* hdrLuminanceImageC;
		idImage* hdrLuminanceImageD;
		idImage* hdrLuminanceImageE;
		idImage* hdrExposureImageA;
