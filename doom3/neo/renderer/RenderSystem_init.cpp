...
idCVar r_interactionTableEntityExtra("r_interactionTableEntityExtra", "1024", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "Extra entity slots reserved for interaction table growth");
idCVar r_interactionTableLightExtra("r_interactionTableLightExtra", "256", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER,	"Extra light slots reserved for interaction table growth");
...
void idRenderSystemLocal::Shutdown(void)
{
	...
	// Delete HDR/framebuffer resources while globalImages and OpenGL still exist.
	Framebuffer::Shutdown();
