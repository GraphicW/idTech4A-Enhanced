...
void idImageManager::Init()
{
	...
	hdrSceneImage = NULL;
	gtaoHistoryImage = NULL;
	mirrorImage = NULL;
	hdrBloomImageA = NULL;
	hdrBloomImageB = NULL;
	hdrLuminanceImageA = NULL;
	hdrLuminanceImageB = NULL;
	hdrLuminanceImageC = NULL;
	hdrLuminanceImageD = NULL;
	hdrLuminanceImageE = NULL;
	hdrExposureImageA = NULL;
