...
void RB_RenderDepthToColor(bool notPack = false)
{
    ...
    common->Printf(
        "DepthTex: %d x %d  Upload: %d x %d  tcw=%f tch=%f\n",
        depthStencilRenderer.Width(),
        depthStencilRenderer.Height(),
        depthStencilRenderer.UploadWidth(),
        depthStencilRenderer.UploadHeight(),
        tcw,
        tch
    );
