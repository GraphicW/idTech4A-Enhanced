...
GLSL_PROGRAM_PROC shaderProgram_t hdrBlurHShader; //HDR blur horizontal postprocess shader
GLSL_PROGRAM_PROC shaderProgram_t hdrBlurVShader;  //HDR blur vertical postprocess shader
GLSL_PROGRAM_PROC shaderProgram_t hdrTonemapShader;  //HDR tonemap postprocess shader
GLSL_PROGRAM_PROC shaderProgram_t hdrBrightPassShader; // HDR bloom bright pass
GLSL_PROGRAM_PROC shaderProgram_t hdrDownsampleShader; // HDR downsample
GLSL_PROGRAM_PROC shaderProgram_t hdrLuminanceShader;  // HDR luminance extraction
...
GLSL_PROGRAM_PROC shaderProgram_t ssgiTraceShader; // SSGI trace shader 
#endif
