...
#define EXPORT_POSTPROCESS_SHADER() \
    ...
    EXPORT_SHADER_SOURCE(HDR_BLUR_H_FRAG, "hdr_blur_h", "frag"); \
    EXPORT_SHADER_SOURCE(HDR_BLUR_V_FRAG, "hdr_blur_v", "frag"); \
    EXPORT_SHADER_SOURCE(HDR_BRIGHTPASS_FRAG, "hdr_brightpass", "frag"); \
    EXPORT_SHADER_SOURCE(HDR_LUMINANCE_FRAG, "hdr_luminance", "frag"); \
    EXPORT_SHADER_SOURCE(HDR_DOWNSAMPLE_FRAG, "hdr_downsample", "frag"); \
    EXPORT_SHADER_SOURCE(HDR_TONEMAP_FRAG, "hdr_tonemap", "frag"); \
    EXPORT_SHADER_SOURCE(HDR_CAS_FRAG, "hdr_cas", "frag"); \
    EXPORT_SHADER_SOURCE(SSGI_FRAG, "ssgi", "frag");
    #endif
