...
"bool d3hdp = (u_specularExponent.z < -100.0);\n"
"\n"
"vec4 roughness;\n"
"vec4 metallic;\n"
"\n"
"    if(d3hdp)\n"
"    {\n"
"        float specLevel = dot(specTex.rgb, vec3(0.2126, 0.7152, 0.0722));\n"
"        roughness = vec4(clamp(0.75 - specLevel * 0.5, 0.10, 0.85));\n"
"        metallic = vec4(0.0);\n"
"    }\n"
"else\n"
"{\n"
"    roughness = vec4(clamp(specTex.r * (sign(1.0 - abs(sign(u_specularExponent.z))) * 2.0 - 1.0) + u_specularExponent.z, 0.0, 1.0) * max(sign(specTex.r), 0.0));\n"
"    metallic = vec4(clamp(specTex.g + u_specularExponent.w, 0.0, 1.0) * max(sign(specTex.g), 0.0));\n"
"}\n"
"#endif\n"
"\n"
...
"    {\n"
"        float specLevel = dot(specTex.rgb, vec3(0.2126, 0.7152, 0.0722));\n"
"        F0 = vec3(mix(0.04, 0.42, specLevel));\n"
"    }\n"
"    else\n"
"    {\n"
