...
#include "renderer/glsl/ShaderManager.h"
...
extern idCVar r_hdr;					// HDR rendering
...
extern idCVar r_interactionTableEntityExtra;  // option to increase or decrease entityDefs
extern idCVar r_interactionTableLightExtra;   // option to increase or decrease lightDefs
...
typedef enum {
	...
	SHADER_HDR_BLUR_H,
	SHADER_HDR_BLUR_V,
	SHADER_HDR_BRIGHTPASS,
	SHADER_HDR_LUMINANCE,
	SHADER_HDR_EXPOSURE,
	SHADER_HDR_DOWNSAMPLE,
	SHADER_HDR_TONEMAP,
	SHADER_HDR_CAS,	
	SHADER_SSGI,
	SHADER_SSGI_TRACE,
...
#define SHADER_POSTPROCESS_END SHADER_SSGI	
#define SHADER_POSTPROCESS_END SHADER_SSGI_TRACE
#endif
