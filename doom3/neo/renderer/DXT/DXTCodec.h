...
#ifndef DXT_INLINE
#if defined(_MSC_VER)
#define DXT_INLINE __forceinline
#elif defined(__GNUC__) || defined(__clang__)
#define DXT_INLINE inline __attribute__((always_inline))
#else
#define DXT_INLINE inline
#endif
#endif
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressImageDXT1Fast( const byte* inBuf, byte* outBuf, int width, int height )
{
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressImageDXT1AlphaFast( const byte* inBuf, byte* outBuf, int width, int height )
{
#if defined(USE_INTRINSICS_SSE)
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressImageDXT5Fast( const byte* inBuf, byte* outBuf, int width, int height )
{
#if defined(USE_INTRINSICS_SSE)
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressImageDXN1Fast( const byte* inBuf, byte* outBuf, int width, int height )
{
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressYCoCgDXT5Fast( const byte* inBuf, byte* outBuf, int width, int height )
{
#if defined(USE_INTRINSICS_SSE)
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressYCoCgCTX1DXT5AFast( const byte* inBuf, byte* outBuf, int width, int height )
{
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressNormalMapDXT5Fast( const byte* inBuf, byte* outBuf, int width, int height )
{
#if defined(USE_INTRINSICS_SSE)
...
========================
*/
DXT_INLINE void idDxtEncoder::CompressNormalMapDXN2Fast( const byte* inBuf, byte* outBuf, int width, int height )
{
...
========================
*/
DXT_INLINE void idDxtEncoder::EmitByte( byte b )
{
	*outData = b;
	outData += 1;
}
...
========================
*/
DXT_INLINE void idDxtEncoder::EmitUShort( unsigned short s )
{
...
========================
*/
DXT_INLINE void idDxtEncoder::EmitUInt( unsigned int i )
{
...
========================
*/
DXT_INLINE unsigned int idDxtEncoder::AlphaDistance( const byte a1, const byte a2 ) const
{
	return ( a1 - a2 ) * ( a1 - a2 );
}
...
========================
*/
DXT_INLINE unsigned int idDxtEncoder::ColorDistance( const byte* c1, const byte* c2 ) const
{
...
========================
*/
DXT_INLINE unsigned int idDxtEncoder::ColorDistanceWeighted( const byte* c1, const byte* c2 ) const
{
	int r, g, b;
	int rmean;
...
========================
*/
DXT_INLINE unsigned int idDxtEncoder::CTX1Distance( const byte* c1, const byte* c2 ) const
{
...
========================
*/
DXT_INLINE unsigned short idDxtEncoder::ColorTo565( const byte* color ) const
{
...
========================
*/
DXT_INLINE void idDxtEncoder::ColorFrom565( unsigned short c565, byte* color ) const
{
...
========================
*/
DXT_INLINE unsigned short idDxtEncoder::ColorTo565( byte r, byte g, byte b ) const
{
...
========================
*/
DXT_INLINE byte idDxtEncoder::GreenFrom565( unsigned short c565 ) const
{
...
========================
*/
DXT_INLINE byte idDxtDecoder::ReadByte()
{
	byte b = *inData;
	inData += 1;
	return b;
...
========================
*/
DXT_INLINE unsigned short idDxtDecoder::ReadUShort()
{
...
========================
*/
DXT_INLINE unsigned int idDxtDecoder::ReadUInt()
{
...
========================
*/
DXT_INLINE unsigned short idDxtDecoder::ColorTo565( const byte* color ) const
{
	return ( ( color[ 0 ] >> 3 ) << 11 ) | ( ( color[ 1 ] >> 2 ) << 5 ) | ( color[ 2 ] >> 3 );
}
...
========================
*/
DXT_INLINE void idDxtDecoder::ColorFrom565( unsigned short c565, byte* color ) const
{
	color[0] = byte( ( ( c565 >> 8 ) & ( ( ( 1 << ( 8 - 3 ) ) - 1 ) << 3 ) ) | ( ( c565 >> 13 ) & ( ( 1 << 3 ) - 1 ) ) );
	color[1] = byte( ( ( c565 >> 3 ) & ( ( ( 1 << ( 8 - 2 ) ) - 1 ) << 2 ) ) | ( ( c565 >>  9 ) & ( ( 1 << 2 ) - 1 ) ) );
	color[2] = byte( ( ( c565 << 3 ) & ( ( ( 1 << ( 8 - 3 ) ) - 1 ) << 3 ) ) | ( ( c565 >>  2 ) & ( ( 1 << 3 ) - 1 ) ) );
...
========================
*/
DXT_INLINE unsigned short idDxtDecoder::NormalYTo565( byte y ) const
{
	return ( ( y >> 2 ) << 5 );
}
...
========================
*/
DXT_INLINE byte idDxtDecoder::NormalYFrom565( unsigned short c565 ) const
{
	byte c = byte( ( c565 & ( ( ( 1 << 6 ) - 1 ) << 5 ) ) >> 3 );
	return ( c | ( c >> 6 ) );
}
...
========================
*/
DXT_INLINE byte idDxtDecoder::NormalBiasFrom565( unsigned short c565 ) const
{
...
========================
*/
DXT_INLINE byte idDxtDecoder::NormalScaleFrom565( unsigned short c565 ) const
{
