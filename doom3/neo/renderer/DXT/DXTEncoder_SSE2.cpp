...
========================
*/
DXT_INLINE void idDxtEncoder::ExtractBlock_SSE2( const byte* inPtr, int width, byte* colorBlock ) const
{
...
========================
*/
DXT_INLINE void idDxtEncoder::GetMinMaxBBox_SSE2( const byte* colorBlock, byte* minColor, byte* maxColor ) const
{
...
========================
*/
DXT_INLINE void idDxtEncoder::InsetColorsBBox_SSE2( byte* minColor, byte* maxColor ) const
{
...
========================
*/
DXT_INLINE void idDxtEncoder::ScaleYCoCg_SSE2( byte* colorBlock, byte* minColor, byte* maxColor ) const
{
	__m128i block0 = *( ( __m128i* )( &colorBlock[ 0] ) );
	__m128i block1 = *( ( __m128i* )( &colorBlock[16] ) );
	__m128i block2 = *( ( __m128i* )( &colorBlock[32] ) );
...
========================
*/
DXT_INLINE void idDxtEncoder::InsetYCoCgBBox_SSE2( byte* minColor, byte* maxColor ) const
{
	__m128c temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7;
...
========================
*/
DXT_INLINE void idDxtEncoder::SelectYCoCgDiagonal_SSE2( const byte* colorBlock, byte* minColor, byte* maxColor ) const
{
	__m128i block0 = *( ( __m128i* )( &colorBlock[ 0] ) );
	__m128i block1 = *( ( __m128i* )( &colorBlock[16] ) );
	__m128i block2 = *( ( __m128i* )( &colorBlock[32] ) );
